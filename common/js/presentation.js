var message = new BroadcastChannel('presentation');
message.onmessage = function (ev) {
...
console.log ('Name: ' + received_data[1] + ', Function: ' + received_data[2]);
...
var params = {
container: document.getElementById('presentation-lottie'),
renderer: 'svg',
loop: false,
autoplay: true,
